                ...
                <div class="card mb-1 border border-warning">
                    <div class="card-header clearfix m-0">
                        <h5 class="panel-title mb-0">
                            ...
                            <div class="btn-group float-end btn-group-sm">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                    ...
                    <form id="form111" onsubmit="return false" method="post" ng-submit="save()" autocomplete="off">
                        <div class="row " id="" style="">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" placeholder="Header title" name="title" id="title" ng-model="op.title">
                            </div>
                            <div class="col-sm-6">
                                <label for="button">Button text</label>
                                <input type="text" class="form-control" placeholder="Button text" name="button" id="button" ng-model="op.button">
                            </div>
                            <div class="col-sm-6">
                                <label for="desc">Description</label>
                                <input type="text" class="form-control" placeholder="Description" name="desc" id="desc" ng-model="op.desc">
                            </div>
                            <div class="col-sm-6">
                                <label for="sql_ms">Add notification</label>
                                <input type="text" class="form-control" placeholder="Add notification" name="sql_ms" id="sql_ms" ng-model="op.sql_ms">
                            </div>
                            <div class="col-sm-6">
                                <label for="success_mes">Exec notification</label>
                                <input type="text" class="form-control" placeholder="Exec notification" name="success_mes" id="success_mes" ng-model="op.success_mes">
                            </div>
                            <div class="col-sm-6">
                                <label for="id">ID</label>
                                <input type="text" class="form-control" placeholder="ID" name="id" id="id" ng-model="op.id">
                            </div>
                            <div class="col-sm-6">
                                <label for="init_fn">Init fn.</label>
                                <input type="text" class="form-control" placeholder="Init fn." name="init_fn" id="init_fn" ng-model="op.init_fn">
                            </div>
                            <div class="col-sm-6">
                                <label for="inputs">Inputs( <small>Comma separated</small> )</label>
                                <input type="text" class="form-control" ng-list placeholder="Inputs" name="inputs" id="inputs" ng-model="op.inputs">
                            </div>
                ...
                <div class="modal-footer">
                    <!-- changes left to start -->
                    <a href="javascript:void(0)" class="btn btn-outline-secondary float-start" data-dismiss="modal">
                        Cancel
                    </a>
