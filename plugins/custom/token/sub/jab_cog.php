...
<div class="container" style="" ng-app="app" ng-controller="jns-ctrl">
    ...
    <h3 class="mt-3">Send jabber to... </h3><small class="float-end"> jab1,jab2,jab3...</small>
    ...
    <div class="clearfix mt-2">
        ...
        <!-- changes float right to end  -->
        <button class="btn btn-outline-info float-end" ng-click="save_jabs()" style="">Save</button>
